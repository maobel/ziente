...
-------------------------------------------------------------------------*/
class Ves_Contentslider_Model_Mysql4_Banner extends Mage_Core_Model_Mysql4_Abstract {
    ...
    protected function _construct() {
        ...
        $this->_init('ves_contentslider/banner', 'banner_id');
    }
  ...
  protected function _afterSave(Mage_Core_Model_Abstract $object)
  {
    ...
    $this->_getWriteAdapter()->delete($this->getTable('ves_contentslider/banner_store'), $condition);
    ...
    if($stores){
      foreach ((array) $object->getData('stores') as $store) {
        ...
        $this->_getWriteAdapter()->insert(
          $this->getTable('ves_contentslider/banner_store'), $storeArray
        );
      } 
    }else{
      $storeArray = array ();
