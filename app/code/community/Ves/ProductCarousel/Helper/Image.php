...
class Ves_ProductCarousel_Helper_Image extends Mage_Core_Helper_Abstract
{
    protected $_model;
    ...
    {
        $this->_reset();
        $this->_setModel(Mage::getModel('ves_productcarousel/banner_image'));
     ...
     *
     * @see ves_productcarousel_Model_Banner_Image
     * @param int $width
     * @param int $height
     * @return ves_productcarousel_Helper_Image
     */
     ...
     * Enter description here...
     *
     * @return ves_productcarousel_Model_Banner_Image
     */
