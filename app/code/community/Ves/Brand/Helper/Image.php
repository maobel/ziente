...
class Ves_Brand_Helper_Image extends Mage_Core_Helper_Abstract
{
    protected $_model;
    ...
    {
        $this->_reset();
        $this->_setModel(Mage::getModel('ves_brand/banner_image'));
     ...
     *
     * @see ves_brand_Model_Banner_Image
     * @param int $width
     * @param int $height
     * @return ves_brand_Helper_Image
     */
     ...
     * Enter description here...
     *
     * @return ves_brand_Model_Banner_Image
     */
