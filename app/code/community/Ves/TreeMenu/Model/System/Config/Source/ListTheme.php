...
class Ves_TreeMenu_Model_System_Config_Source_ListTheme
{
    ...
    public function toOptionArray()
    {
		...
		$directory = Mage::getBaseDir('design') . DS . 'frontend' . DS . 'default' . DS . 'default' .  DS . 'template'.  DS . 'ves'. DS .'treemenu';
