...
class Ziente_Appointments_Block_Adminhtml_Locations_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
		...
		public function getHeaderText()
		{
				if( Mage::registry("locations_data") && Mage::registry("locations_data")->getId() ){
				    ...
				    return Mage::helper("appointments")->__("Edit Item '%s'", $this->htmlEscape(Mage::registry("locations_data")->getId()));
